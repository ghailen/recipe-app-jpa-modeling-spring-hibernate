package com.ghailene.recipeappjpadatamodelingspringhibernate.bootstrap;

import com.ghailene.recipeappjpadatamodelingspringhibernate.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setUrl("http://wwww.simplyrecipes.com/recipes/perfect_quacmole/");
